package com.nnc.app.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addOAuthClientDetails(MongoTemplate mongoTemplate) {
        ...
        appDetails.setClientId("NgxNosqlCrmapp");
        appDetails.setClientSecret("my-secret-token-to-change-in-production");
        appDetails.setResourceIds(Collections.singletonList("res_NgxNosqlCrm"));
        ...
        swaggerUIDetails.setResourceIds(Collections.singletonList("res_NgxNosqlCrm"));
